...
class TestCreateConsistentDescription:
    ...
    def test_upr_assignment_export_keeps_original_description(self):
        desc = create_consistent_description(
            "activity",
            "admin_plugin",
            None,
        ...
        assert desc == "Generated UPR (PDF)"

    def test_upr_generate_keeps_more_specific_description(self):
        desc = create_consistent_description(
            "activity",
            "admin_plugin",
            None,
            "Generated UPR (PNG with narrative)",
            endpoint="upr.generate",
            http_method="POST",
        )
        assert desc == "Generated UPR (PNG with narrative)"
