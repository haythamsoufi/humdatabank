...
class AppTheme {
  ...
  static ThemeData _buildTheme(
    ...
    return ThemeData(
      ...
      // Page motion: iOS keeps native swipe-back; Material 3 uses the modern
      // [ZoomPageTransitionsBuilder] (depth-cued zoom-fade) which gives pushed
      // routes a more polished feel than the older fade-upwards transition.
      ...
      snackBarTheme: SnackBarThemeData(
        ...
        backgroundColor: isDark
            ? const Color(AppConstants.themeElevatedSurfaceDark)
            : const Color(AppConstants.themeSnackBarLight),
