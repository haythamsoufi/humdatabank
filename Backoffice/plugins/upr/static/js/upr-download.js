(function (global) {
  ...
  function modalEls() {
    return {
      root: document.getElementById("upr-narrative-modal"),
      format: document.getElementById("upr-narrative-format"),
      file: document.getElementById("upr-narrative-file"),
      status: document.getElementById("upr-narrative-status"),
      submit: document.getElementById("upr-narrative-submit"),
      dropzone: document.getElementById("upr-narrative-dropzone"),
      audience: document.getElementById("upr-narrative-audience"),
      audienceHint: document.getElementById("upr-narrative-audience-hint"),
      progress: document.getElementById("upr-narrative-progress"),
      progressBar: document.querySelector("#upr-narrative-progress .upr-narrative-progress__bar"),
      progressLabel: document.getElementById("upr-narrative-progress-label"),
    };
  }
  ...
  async function submitNarrative() {
    ...
    try {
      ...
      const fallback = fmt === "idml" ? "UPR - InDesign.zip" : "UPR.pdf";
  ...
  function bindNarrativeModal() {
    ...
    root.querySelectorAll(".close-modal, .upr-narrative-close").forEach((el) => {
  ...
  function downloadStatusEl(box) {
    if (!box) return null;
    let el = box.querySelector(".upr-download__status");
    if (el) return el;
    el = document.createElement("span");
    el.className = "upr-download__status";
  ...
  function bindDownloadMenu({ button, menu, wrap, aesIdFn, dashboardFn }) {
    ...
    bindNarrativeModal();
    const box = wrap || button.closest(".upr-download");
