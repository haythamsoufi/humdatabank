...
class AuthorizationService:
    ...
    @staticmethod
    def _can_return_scoped_item(assignment_entity_status: AssignmentEntityStatus, user) -> bool:
        if not user or not user.is_authenticated:
            return False
        if not AuthorizationService.can_access_assignment(assignment_entity_status, user):
            return False
    ...
    def can_return_assignment_page(assignment_entity_status: AssignmentEntityStatus, user) -> bool:
        return AuthorizationService._can_return_scoped_item(assignment_entity_status, user)
