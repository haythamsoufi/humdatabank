...
Most endpoints require JWT Bearer authentication via ``@mobile_auth_required``.
Public data endpoints (country map, sectors, indicator bank, FDRS overview)
are unauthenticated but rate-limited.
