    ...
    $(document).ready(function() {
        ...
        document.getElementById('entity-grid-bulk-delete-btn')?.addEventListener('click', function() {
            ...
            function doRemove() {
                ...
                fetch('' + '/admin/assignments/' + cfg.assignmentId + '/entities/bulk-remove', {
                    method: 'POST',
        ...
        function bulkUpdatePublicAvailability(enable) {
            ...
            function doUpdate() {
                const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content');
                fetch('' + '/admin/assignments/' + cfg.assignmentId + '/entities/bulk-update-public', {
                    method: 'POST',
                    headers: { 'Content-Type': 'application/json', 'X-CSRFToken': csrfToken || '' },
        ...
        document.getElementById('bulk-status-form')?.addEventListener('submit', function(e) {
            ...
            const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content');
            fetch('' + '/admin/assignments/' + cfg.assignmentId + '/entities/bulk-update-status', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRFToken': csrfToken || '' },
        ...
        document.getElementById('bulk-duedate-selected-form')?.addEventListener('submit', function(e) {
            ...
            const csrfToken = document.querySelector('meta[name="csrf-token"]')?.getAttribute('content');
            fetch('' + '/admin/assignments/' + cfg.assignmentId + '/entities/bulk-update-due-date', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json', 'X-CSRFToken': csrfToken || '' },
        ...
        if (togglePublicAccessBtn) {
            togglePublicAccessBtn.addEventListener('click', function() {
                ...
                form.method = 'POST';
                form.action = '' + '/admin/assignments/' + cfg.assignmentId + '/toggle_public_access';
