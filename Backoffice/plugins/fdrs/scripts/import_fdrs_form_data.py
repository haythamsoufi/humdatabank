...
# Add Backoffice + plugin scripts + core scripts/imports to path
from pathlib import Path as _Path

_scripts_root = _Path(__file__).resolve().parents[3] / "scripts"
if str(_scripts_root) not in sys.path:
    sys.path.insert(0, str(_scripts_root))
from _bootstrap import setup_cli_paths  # noqa: E402

_backoffice_root, script_dir = setup_cli_paths(__file__, plugin_id="fdrs")
script_dir = str(script_dir)
backoffice_dir = str(_backoffice_root)

if "FLASK_CONFIG" not in os.environ:
    os.environ["FLASK_CONFIG"] = "development"

from form_row_upsert import (  # noqa: E402
    ALL_COLUMNS,
    COL_ASSIGNMENT,
    COL_DATA_NA,
    COL_DISAGG,
    ...
    _excel_cell_value,
    _normalize_headers,
    _normalize_json_numbers_to_ints,
    _parse_scalar_field,
    _to_whole_number_int,
    flask_app_for_import as _flask_app_for_import,
    row_to_payload,
