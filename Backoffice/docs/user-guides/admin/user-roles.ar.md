...
**يتضمن:**
- جميع أدوار وحدات المسؤول (المستخدمون، القوالب، المهام، الدول، المؤشرات، المحتوى، التحليلات، التدقيق، مستكشف البيانات، الذكاء الاصطناعي، الاتصالات، الترجمات، واجهة برمجة التطبيقات)
...
#### مسؤول: مدير الاتصالات
**رمز الدور:** `admin_communication_manager`

**القدرات:**
- عرض جميع الاتصالات
- إرسال الإشعارات والبريد الإلكتروني والدفع من مركز الاتصالات
