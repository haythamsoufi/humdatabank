...
class NotificationService:
    ...
    def _serialize_email_delivery_log(log: Optional[Any]) -> Dict[str, Any]:
        ...
        return {
            ...
            'email_content': '',
            'email_sent_at': ensure_utc(log.sent_at).isoformat() if log.sent_at else '',
            'email_logged_at': ensure_utc(log.created_at).isoformat() if log.created_at else '',
            'email_failed_at': ensure_utc(log.failed_at).isoformat() if log.failed_at else '',
