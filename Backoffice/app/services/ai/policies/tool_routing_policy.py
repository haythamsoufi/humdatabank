"""
AI tool loop-guard and source-toggle helpers.

Tool *selection* is LLM-driven — see ``agent_routing.AgentRoutingPolicy``.
This module only provides structural guards (dedupe, pagination caps, UI toggles).
"""
