...
This repo is a **monorepo**: **Backoffice** (Flask), **Website** (Next.js), and **MobileApp** (Flutter). Day-to-day setup, conventions, and “where to change things” live in the **[Developer handbook](docs/DEVELOPER-HANDBOOK.md)** and each app’s README.
...
- Read the **[Developer handbook](docs/DEVELOPER-HANDBOOK.md)** for migrations (single migration head), CSRF/fetch patterns, Tailwind rebuild for Backoffice templates, environment notes, and feature conventions.
