...
- To support reliable retrieval/QA, we extract UPR into **structured JSON metadata**
...
from plugins.upr.excel.pns_parsing import (
...
def infer_upr_document_context(
    *,
    ...
    This is intentionally best-effort and non-fatal: UPR can be parsed without it,
        ...
        *,
        ...
        try:
            ...
            prompt = (
                ...
                "UPR are infographic-like and layouts can vary slightly by year and country.\n"
