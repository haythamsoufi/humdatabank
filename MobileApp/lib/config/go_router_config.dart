// ============================================================================
// WARNING — NOT ACTIVE AT RUNTIME
// ============================================================================
// This file defines a go_router route tree that mirrors app_router.dart /
// routes.dart but is NOT wired to MaterialApp.router in main.dart.
//
// The app currently runs on Navigator 1.0 (AppRouter / AppRoutes).
// Completing the migration requires:
//   1. Switching MaterialApp → MaterialApp.router(routerConfig: AppGoRouter.createRouter())
//   2. Removing duplicate route registrations from routes.dart / app_router.dart
//   3. Fixing the default-tab index mismatch (go_router uses tabIndex=1 here;
//      Navigator 1.0 uses initialTabIndex ?? 2 in MainNavigationScreen).
//
// DO NOT register paths in BOTH this file and app_router.dart simultaneously.
// See MobileApp/README.md → Architecture notes for migration plan.
// ============================================================================
