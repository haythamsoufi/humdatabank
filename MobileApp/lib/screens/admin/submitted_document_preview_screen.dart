...
class SubmittedDocumentPreviewScreen extends StatefulWidget {
  ...
  @override
  State<SubmittedDocumentPreviewScreen> createState() =>
      _SubmittedDocumentPreviewScreenState();
}

class _SubmittedDocumentPreviewScreenState
    extends State<SubmittedDocumentPreviewScreen>
    with AdminScreenViewLoggingMixin {
  @override
  String get adminScreenViewRoutePath => '/admin/documents/preview';
          ...
          : SelectableRegion(
              ...
              child: SingleChildScrollView(
                ...
                child: SelectableText(
                  _decodePlainText(widget.bytes, fileName: widget.fileName),
  ...
  static String _decodePlainText(Uint8List bytes, {String? fileName}) {
    ...
    if (SubmittedDocumentPreviewScreen._fileNameLooksLikePlainText(fileName) &&
