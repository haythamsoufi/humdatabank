...
class AccessRequestsProvider with ChangeNotifier, AsyncOperationMixin {
  ...
  Future<bool> approveAll() async {
    return _postAction(
      AppConfig.mobileApproveAllAccessRequestsEndpoint,
      contextLabel: 'Approve all access requests',
    );
  }
