...
class TestCountryService:
    ...
    def test_get_by_id_not_exists(self, app, db_session):
    ...
    def test_get_by_iso2_not_exists(self, app, db_session):
    ...
    def test_get_by_iso3_not_exists(self, app, db_session):
