...
UPR vary slightly (e.g., multi-year vs single-year funding panels).
"""
...
from plugins.upr.ai.visual_chunking import extract_upr_visual_blocks
...
def _vision_suggest_upr_layouts(
    *,
    ...
    """
    Ask a vision-capable model to identify which UPR/layout variants appear on pages 1..N.
