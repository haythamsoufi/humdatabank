...
SPECS: dict[tuple[str, str], ActivityEndpointSpec] = {
    ...
    ("POST", "system_admin.api_patch_measurement_type_translations"): ActivityEndpointSpec(description="Updated Measurement Type Translations", activity_type="admin_system"),
    ("POST", "system_admin.api_patch_measurement_unit_translations"): ActivityEndpointSpec(description="Updated Measurement Unit Translations", activity_type="admin_system"),
