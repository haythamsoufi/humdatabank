...
class _ResourceCardState extends State<_ResourceCard>
  ...
  static Color _accentForType(String? type) {
    switch (type) {
      case 'publication':
        return const Color(AppConstants.semanticCategoryBlueStart);
      case 'document':
        return const Color(AppConstants.semanticCategoryGreenStart);
      case 'other':
        return const Color(AppConstants.semanticCategoryOrangeFallbackText);
      default:
        return const Color(AppConstants.semanticCategoryPurpleStart);
    }
  }
  ...
  static List<Color> _gradientForType(String? type) {
    switch (type) {
      case 'publication':
        return [
          const Color(AppConstants.semanticCategoryBlueStart),
          const Color(AppConstants.semanticCategoryBlueEnd),
        ];
      case 'document':
        return [
          const Color(AppConstants.semanticCategoryGreenStart),
          const Color(AppConstants.semanticCategoryGreenEnd),
        ];
      case 'other':
        return [
          const Color(AppConstants.semanticCategoryOrangeStart),
          const Color(AppConstants.semanticCategoryOrangeEnd),
        ];
      default:
        return [
          const Color(AppConstants.semanticCategoryPurpleStart),
          const Color(AppConstants.semanticCategoryPurpleEnd),
        ];
    }
  }
