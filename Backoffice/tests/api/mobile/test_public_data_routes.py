...
class TestCountryMap:
    def test_accessible_without_auth(self, client, db_session):
        """countrymap is a public endpoint — no login required."""
...
class TestSectorsSubsectors:
    def test_returns_data(self, client, jwt_headers, db_session):
        ...
        # Subsectors are embedded inside each sector object (not a top-level key)
