...
**Note:** Existing prod rows from this incident remain split until backfilled or ignored; new assignment-created sends after deploy should show **Notification + email** on one row.
...
| Data | Assignment **created**; **299** notifications + **121** emails **delivered** |
