...
Flujos de trabajo paso a paso y tutoriales para usar el sistema de Backoffice de la Base de Datos Humanitarios.
...
- [AI Chatbot](common/ai-chatbot.md) – Cómo funciona el chatbot, niveles de acceso, privacidad de documentos y herramientas disponibles
...
La documentación se muestra en el idioma seleccionado en **Configuración de cuenta**. Los idiomas de las guías soportados incluyen **inglés**, **francés**, **español**, **árabe** y **ruso**. Si una página aún no está traducida, se muestra la versión en inglés.
