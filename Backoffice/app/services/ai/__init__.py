...
Subpackages:
    ...
    ai.quality       – reasoning trace, answer verifier, grounding, regression tests
    ai.runtime       – step UX, tool observation, runtime utils
    ai.validation    – form-data validation against RAG
    ai.agent         – agent executor and circuit breaker
    ai.tools         – tool registry and helpers
    ai.data          – form-data retrieval tools for the agent
"""
