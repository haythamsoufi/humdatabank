...
- **[Runbooks index](runbooks/README.md)** — Incidents & triage (WAF 403), security guardrails (RBAC audit exemptions), deployment (Azure App Service), data (migrations, backup), observability (logs, AI health), mobile API v1, sessions, integrations, frontend CSS/CSP tooling, AI architecture/cost/RAG/indicators (`runbooks/` is organised by subfolders)
