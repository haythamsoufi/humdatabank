...
void setupServiceLocator() {
  ...
  sl.registerLazySingleton<IfrcUnifiedPlanningService>(
      () => IfrcUnifiedPlanningService.instance);
  sl.registerLazySingleton<ScreenViewTracker>(() => ScreenViewTracker());

  // ── Tier 2: Depend on Tier 1 (StorageService) ────────────────────────
  sl.registerLazySingleton<ApiService>(() => ApiService());
  sl.registerLazySingleton<JwtTokenService>(() => JwtTokenService());
