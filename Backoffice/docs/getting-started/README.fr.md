...
Cette section vous aide à vous orienter et à commencer à utiliser le Backoffice.
...
- Comprendre les principaux domaines de la plateforme
- Apprendre les flux de travail essentiels pour votre rôle
- Trouver où se trouvent les éléments dans l'interface utilisateur
...
- [Comment fonctionne la plateforme](how-it-works.md)
