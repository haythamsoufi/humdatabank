...
SPECS: dict[tuple[str, str], ActivityEndpointSpec] = {
    ...
    ("POST", "system_admin.api_patch_measurement_type_translations"): ActivityEndpointSpec(description="Completed Patch Measurement Type Translations", activity_type="admin_system"),
    ("POST", "system_admin.api_patch_measurement_unit_translations"): ActivityEndpointSpec(description="Completed Patch Measurement Unit Translations", activity_type="admin_system"),
    ("POST", "system_admin.api_patch_spef_translations"): ActivityEndpointSpec(description="Completed Patch Spef Translations", activity_type="admin_system"),
    ...
    ("POST", "system_admin.delete_measurement_unit"): ActivityEndpointSpec(description="Deleted Measurement Unit", activity_type="admin_system"),
    ...
    ("POST", "system_admin.delete_spef_lookup"): ActivityEndpointSpec(description="Deleted Spef Lookup", activity_type="admin_system"),
    ...
    ("POST", "system_admin.edit_measurement_type"): ActivityEndpointSpec(description="Edited Measurement Type", activity_type="admin_system"),
    ("POST", "system_admin.edit_measurement_unit"): ActivityEndpointSpec(description="Edited Measurement Unit", activity_type="admin_system"),
    ...
    ("POST", "system_admin.edit_spef_lookup"): ActivityEndpointSpec(description="Edited Spef Lookup", activity_type="admin_system"),
    ...
    ("POST", "system_admin.new_measurement_type"): ActivityEndpointSpec(description="Created Measurement Type", activity_type="admin_system"),
    ("POST", "system_admin.new_measurement_unit"): ActivityEndpointSpec(description="Created Measurement Unit", activity_type="admin_system"),
    ...
    ("POST", "system_admin.new_spef_lookup"): ActivityEndpointSpec(description="Created Spef Lookup", activity_type="admin_system"),
