...
export async function exportToPDF(formId, title) {
    ...
    try {
        ...
        (window.__clientLog || console.log)('Starting sophisticated PDF export for form:', formId);
        ...
        (window.__clientLog || console.log)('🎉 Advanced PDF Export Completed Successfully!');
        (window.__clientLog || console.log)('📊 Export Summary:', exportSummary);
        ...
        button.addEventListener('click', (e) => {
            ...
            try {
                ...
                if (window.showAlert) {
                    ...
                    (window.__clientWarn || console.warn)('Failed to start PDF export.');
                }
            } finally {
