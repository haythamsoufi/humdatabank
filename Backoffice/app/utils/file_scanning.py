    ...
    def scan_file(file_storage: FileStorage) -> Dict[str, any]:
        ...
        try:
            if scanner_type == 'none' or not scanner_type:
                # When scanner is explicitly disabled, apply the configured fail-open policy.
                # Callers that set FILE_SCANNER_FAIL_OPEN=False expect FileScanError to be raised.
                return FileScanner._handle_failure('none', 'File scanner disabled', fail_open)
