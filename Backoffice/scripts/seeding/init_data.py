            ...
            if all(inspector.has_table(table) for table in essential_tables):
                ...
                if inspector.has_table('system_settings'):
                    ...
                    if settings_count == 0:
                        ...
                        from app.services.platform.app_settings_service import set_supported_languages, set_document_types, set_age_groups, set_sex_categories, set_enabled_entity_types
