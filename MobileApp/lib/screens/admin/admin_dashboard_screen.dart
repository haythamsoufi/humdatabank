...
/// Skeleton loader for the admin dashboard while stats load.
/// Mirrors the high-level shape: header strip, 2x2 metric grid, action row.
class _DashboardSkeleton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: const [
        ShimmerTilePlaceholder(height: 92, borderRadius: 16),
        SizedBox(height: 16),
        Row(
          children: [
            Expanded(child: ShimmerTilePlaceholder()),
            SizedBox(width: 12),
            Expanded(child: ShimmerTilePlaceholder()),
          ],
        ),
        ...
        SizedBox(height: 24),
        ShimmerTilePlaceholder(height: 140, borderRadius: 16),
        SizedBox(height: 16),
        ShimmerTilePlaceholder(height: 200, borderRadius: 16),
      ],
    );
  }
}
