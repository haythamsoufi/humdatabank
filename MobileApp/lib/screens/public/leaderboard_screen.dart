...
class _LeaderboardScreenState extends State<LeaderboardScreen>
  ...
  static Color _avatarColor(String name) {
    final palette = AppConstants.semanticAvatarPalette
        .map((v) => Color(v))
...
class _Podium extends StatelessWidget {
  ...
  static const _podiumColors = [
    Color(AppConstants.semanticPodiumGold),
    Color(AppConstants.semanticPodiumSilver),
    Color(AppConstants.semanticPodiumBronze),
  ];
...
class _LoadingView extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    return AppLoadingIndicator(message: loc.quizGameLoadingLeaderboard);
  }
}
