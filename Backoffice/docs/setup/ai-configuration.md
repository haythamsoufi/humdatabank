...
The Backoffice includes an AI chat and RAG (document QA) stack. This page focuses on environment variables and operational wiring; for endpoints, architecture, and troubleshooting breadth see **[Developer handbook](../../../docs/DEVELOPER-HANDBOOK.md)** (AI section) and runbooks under **`docs/runbooks/ai/`**.
