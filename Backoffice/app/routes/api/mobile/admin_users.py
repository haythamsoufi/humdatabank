...
def update_user(user_id):
    ...
    if 'rbac_role_ids' in data:
        ...
        # non-system-managers outright instead of relying solely on the filter
        # below and the sys_role/plugins_role checks further down, which
...
def activate_user(user_id):
    ...
    Uses ``admin.users.deactivate`` permission intentionally — this permission
    controls the ability to change a user's active/inactive state in both
