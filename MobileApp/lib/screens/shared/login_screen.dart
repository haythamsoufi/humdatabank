...
class _LoginScreenState extends State<LoginScreen> {
  ...
  /// Builds a dismissible debug banner shown in non-release builds when the
  /// previous session was definitively invalidated by the server.  Gives the
  /// raw auth reason (e.g. "JWT refresh failed", "Session blacklisted") plus a
              ...
              children: [
                ...
                Row(
                  children: [
                      ...
                      onTap: () async {
                        ...
                        if (mounted) {
                          ScaffoldMessenger.of(context).showSnackBar(
                            const SnackBar(
                              content: Text('Reason copied to clipboard'),
                    ...
                    GestureDetector(
                      onTap: () => authProvider.clearSessionInvalidationReason(),
                      child: const Text(
                        'Dismiss',
                        style: TextStyle(
                          fontSize: 12,
                ...
                child: Padding(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _buildSessionInvalidationBanner(authProvider),
                Image.asset(
