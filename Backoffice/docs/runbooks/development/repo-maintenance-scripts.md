...
| `ci/check_translations_current.py` | Blocking Backoffice CI gate: translations catalog vs source and `.po` compile. Run after `i18n/extract_update_translations.py` when regenerating strings. |
