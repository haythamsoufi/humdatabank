...
**Scope:** UPR **People reached** dashboard only (report template 33).  
...
```text
pytest plugins/upr/tests/test_data_helpers.py plugins/upr/tests/test_formatters_render.py --no-cov
```
