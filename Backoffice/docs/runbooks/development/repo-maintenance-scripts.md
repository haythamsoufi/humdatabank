...
| `plugins/fdrs/scripts/import_fdrs_form_data.py` | FDRS → form_data sync (CLI and admin data-sync UI). |
| `plugins/fdrs/scripts/verify_fdrs_sync.py` | Compare FDRS API KPI values to synced `form_data` (Excel: matched / skipped / missing / mismatch). |
| `plugins/upr/scripts/import_upr_excel_data.py` | UPR Master Excel import (CLI and admin wizard). |
