...
| `codemods/` | Template/JS bulk refactors (inline-JS extraction, button migrations). See `scripts/codemods/README.md`. |
| `archive/` | Completed one-offs and incident probes — reference only. See `scripts/archive/README.md`. |
