...
from app.services.validation_check_service import evaluate_validation_checks, run_validation_checks
...
def test_run_validation_checks_requires_rule_pack():
    ...
    with patch("app.services.validation_check_service.FormTemplate.query") as mock_tpl:
