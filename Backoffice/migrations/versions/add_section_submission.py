"""Add per-section submission flag and assignment_section_status.

Revision ID: add_section_submission
Revises: add_ns_status
...
revision = "add_section_submission"
down_revision = "add_ns_status"
branch_labels = None
depends_on = None
