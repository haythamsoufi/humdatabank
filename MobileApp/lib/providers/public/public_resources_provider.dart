...
class PublicResourcesProvider with ChangeNotifier, AsyncOperationMixin {
  ...
  Future<(List<ResourceListSection>, bool)> _fetchGrouped() async {
    ...
    final data = mobileDataMapLoose(json);
    final meta = json['meta'] as Map<String, dynamic>? ?? {};
